...
export default function Contact() {
  return (
    <section id="contact" className="bg-[#0f172a] text-white py-16 md:py-24 lg:py-28">
      <div className="mx-auto w-full sm:w-[90vw] md:w-[80vw] lg:w-[70vw] max-w-5xl px-4 sm:px-6">
        <motion.div
          className="relative rounded-[2.5rem] bg-white/5 backdrop-blur-md ring-1 ring-white/10 
                     shadow-xl px-6 sm:px-10 py-12 sm:py-20 text-center space-y-8
                     transition-shadow hover:shadow-[0_0_30px_rgba(255,255,255,0.2)]"
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-3 rounded-full bg-blue-600 
                       px-6 py-3 md:px-10 md:py-4 font-semibold text-white
          ...
          <ul className="flex justify-center gap-6 md:gap-8 text-2xl md:text-3xl">
