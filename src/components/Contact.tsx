...
const socials = [
  { icon: FaLinkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/tu-usuario" },
  ...
  return (
    <section id="contact" className="bg-[#0f172a] text-white py-28">
      <div className="mx-auto w-[70vw] max-w-6xl px-6">
        <motion.div
          className="relative rounded-[2.5rem] bg-white/5 backdrop-blur-md ring-1 ring-white/10 shadow-xl px-10 py-20 text-center space-y-8
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-3 rounded-full bg-blue-600 px-10 py-4 font-semibold text-white hover:bg-blue-500 transition-colors"
